...
const Filters = ({
  ...
  return (
    <div className="relative z-40 space-y-4 rounded-2xl border border-slate-200 bg-gradient-to-b from-white to-slate-50 p-4 shadow-sm">
      ...
      {showAdvanced && (
        <div className="relative z-40 grid grid-cols-1 gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-inner sm:grid-cols-2 lg:grid-cols-4">
