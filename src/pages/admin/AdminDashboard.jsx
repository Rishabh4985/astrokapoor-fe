...
const AdminDashBoard = () => {
  ...
  const [filter, setFilter] = useState(() => sessionStorage.getItem("filterType") || "all");
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 min-h-screen bg-gray-50 space-y-8">
      <header className="text-center space-y-1">
        <h1 className="text-4xl font-bold text-orange-900 tracking-wide">AstroKapoor</h1>
        <h2 className="text-2xl font-semibold text-orange-700">Admin Dashboard</h2>
      </header>
