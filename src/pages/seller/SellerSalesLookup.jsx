...
const SellerSalesLookup = () => {
  ...
  // Excel Export (all matching server-side records, not just current page)
  const handleExport = useCallback(() => {
    return fetchAllRecordsForExport()
      .then((exportData) => {
      ...
      .catch((error) => {
        toast.error(error.message || "Failed to fetch records for export");
        return [];
      });
  }, [fetchAllRecordsForExport]);
